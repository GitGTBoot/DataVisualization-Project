...
// Reading csv file
csv_file = "static/data/PieChart_Years_Data_2014_2019.csv"
      ...
      metaData.forEach((row) => {
        ...
        if(row.year == year)
        {
          ...
          Object.entries(row).forEach((key,value) => {
            ...
            metaData_panel.append("h6").text(`${sample_labels[0]}: ${sample_labels[1]}`)
...
function buildCharts(year) {   // 1
  ...
  d3.csv(csv_file).then(sampleData =>{
...
/*******************************************************/
// Function if dropdown option changed
